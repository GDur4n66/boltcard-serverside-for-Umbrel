...
INSERT INTO settings (name, value) VALUES ('AES_DECRYPT_KEY', 'ランダム値'); -- set this. この値がk1になる。生成例) hexdump -vn16 -e'4/4 "%08x" 1 "\n"' /dev/random
...
INSERT INTO settings (name, value) VALUES ('LNDHUB_URL', 'http://boltcard_lndhub:9002'); -- see docker-compose.yml
